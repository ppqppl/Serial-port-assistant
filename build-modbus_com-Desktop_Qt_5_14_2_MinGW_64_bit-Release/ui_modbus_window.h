...
public:
    ...
    void setupUi(QMainWindow *Modbus_Window)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/Img/images/connect.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionConnect->setIcon(icon);
        actionDisconnect = new QAction(Modbus_Window);
        actionDisconnect->setObjectName(QString::fromUtf8("actionDisconnect"));
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/Img/images/disconnect.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionDisconnect->setIcon(icon1);
        actionExit = new QAction(Modbus_Window);
        actionExit->setObjectName(QString::fromUtf8("actionExit"));
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/Img/images/exit.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionExit->setIcon(icon2);
        actionConfig = new QAction(Modbus_Window);
        actionConfig->setObjectName(QString::fromUtf8("actionConfig"));
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/Img/images/settings.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionConfig->setIcon(icon3);
        actionSave = new QAction(Modbus_Window);
        actionSave->setObjectName(QString::fromUtf8("actionSave"));
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/Img/images/save.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionSave->setIcon(icon4);
        actionRefresh = new QAction(Modbus_Window);
        actionRefresh->setObjectName(QString::fromUtf8("actionRefresh"));
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/Img/images/refresh.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/Img/images/books.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/Img/images/Write.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon8;
        icon8.addFile(QString::fromUtf8(":/Img/images/send.png"), QSize(), QIcon::Normal, QIcon::Off);
